 ...
 * @Date 12/3/2016
 * Source file a sample example to understand the concept and Implementation of mapStruct Easily
 */
...
public class DestinationFile {
	...
	public String toString() {
		return "Target [bigDecimal2=" + bigDecimal2 + ", bigDecimal3=" + bigDecimal3 + ", bigDecimal2UnConstrained="
